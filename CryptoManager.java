...
public class CryptoManager {
	...
	public static String bellasoEncryption(String plainText, String bellasoStr) {
	    ...
	    for (int i = 0; i < plainText.length(); i++) {
	        ...
	        char newChar = (char) (((plainChar + bellasoChar - LOWER_RANGE) % RANGE )+ LOWER_RANGE);
	        encryptedText += newChar;
	    }
	    return encryptedText;
	}
	...
	public static String caesarDecryption (String encryptedText, int key) {
	    ...
	    for (int i = 0; i < encryptedText.length(); i++) {
	        ...
	        char newChar = (char) ((encryptedChar - key - LOWER_RANGE + RANGE) % RANGE + LOWER_RANGE);
	...
	public static String bellasoDecryption(String encryptedText, String bellasoStr) {
		...
		for(int i = 0; i<encryptedText.length();i++ ) {
			char encryptedChar= encryptedText.charAt(i);
			char bellasoChar = bellasoStr.charAt(i % bellasoStr.length());
			char newChar = (char) (((encryptedChar - LOWER_RANGE - bellasoChar + 2*RANGE) % RANGE) + LOWER_RANGE);
